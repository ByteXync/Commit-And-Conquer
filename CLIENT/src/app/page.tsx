      ...
      <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-sm z-50 border-b border-blue-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex justify-between items-center">
          ...
          <div className="flex space-x-2">
            ...
            <Button className="rounded-full bg-green-600 hover:bg-green-700" asChild>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2 text-left space-y-6">
            ...
            <div className="flex space-x-4 pt-4">
              <Button size="lg" className="rounded-full bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-200" asChild>
                <a href="/admin/login">Admin Login</a>
              </Button>
              <Button size="lg" className="rounded-full bg-green-600 hover:bg-green-700 shadow-lg shadow-green-200" asChild>
                <a href="/user/login">User Login</a>
              </Button>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-white text-blue-700 hover:bg-blue-50 rounded-full shadow-lg" asChild>
              <a href="/user/login">User Login</a>
            </Button>
            <Button size="lg" className="bg-white text-green-700 hover:bg-blue-50 rounded-full shadow-lg" asChild>
              <a href="/admin/login">Admin Login</a>
            </Button>
          </div>
        </div>
